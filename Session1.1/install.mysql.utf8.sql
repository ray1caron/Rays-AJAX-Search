...
CREATE TABLE IF NOT EXISTS `#__ajaxsearch_cache` (
...
CREATE TABLE IF NOT EXISTS `#__ajaxsearch_sp_cache` (
    `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__ajaxsearch_analytics` (
    `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- Configuration table
CREATE TABLE IF NOT EXISTS `#__ajaxsearch_config` (
    `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT IGNORE INTO `#__ajaxsearch_config` 
